 ...
 */
public class IS_A_Table_Per_Class {

    public static void main (String[] args){

        Configuration cfg = new Configuration();
        cfg.configure("is_a_tableperclass_hibernate.cfg.xml");
        ...
        CompanyEmployee emp1 = new SoftwareCompanyEmployee( "abc", "abc@gmail.com", 10000,"java");
        CompanyEmployee emp2 = new HardwareCompanyEmployee("pqr", "pqr@gmail.com", 20000,10);
        CompanyEmployee emp3 = new Admin("xyz", "xyz@gmail.com", 40000,"finance");
